...
DropletCreateRequest _$DropletCreateRequestFromJson(Map<String, dynamic> json) {
  return DropletCreateRequest(json['name'] as String, json['region'] as String,
      json['size'] as String, json['image'] as int,
      ssh_keys: (json['ssh_keys'] as List)?.map((e) => e as int)?.toList(),
      ...
      volumes: (json['volumes'] as List)?.map((e) => e as String)?.toList(),
